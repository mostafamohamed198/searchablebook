...
class Rheostat extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const valuesChangedThroughState =
      !isEqual(values, nextProps.values) && !isEqual(prevState.values, values);
    const valuesChangedThroughProps =
      !isEqual(prevProps.values, nextProps.values) &&
      isEqual(prevState.values, values);
