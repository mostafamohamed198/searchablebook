...
import { SearchHit, SearchResponseBody, QueryDslQueryContainer, SearchRequest as SearchRequest$1 } from '@elastic/elasticsearch/lib/api/types';
...
interface RequestOptions {
     ...
     */
    getQuery?: (query: string, search_attributes: SearchAttribute[], config: SearchSettingsConfig) => ElasticsearchQuery | ElasticsearchQuery[];
    /**
...
declare class Searchkit {
    ...
    handleInstantSearchRequests(instantsearchRequests: MultipleQueriesQuery$1[], requestOptions?: RequestOptions): Promise<{
        results: ({
            facetHits: any;
