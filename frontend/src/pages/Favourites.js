  ...
  return (
    ...
    <div className="ais-InstantSearch">
      <InstantSearch indexName="entries" searchClient={searchClient}>
        <div style={{ display: 'none' }}>
          <Configure filters={`favouriteusers.id.key:${user.user_id}`} hitsPerPage={15} />
        </div>
        <div className="SR--pandel--div">
          <Sidebar defaultCollapsed={collapsedWidth()} rtl={true} style={{ zIndex: 0 }}>
            <Menu>
              ...
              <SubMenu
                icon=""
                defaultOpen={true}
                style={{ fontSize: '18px', fontWeight: '700', color: '#087cc4', overflow: 'hidden', borderBottom: 'solid rgb(220, 220, 220)', borderWidth: '2px' }}
                label='الدولة:'
              >
                <Panel>
                  <RefinementList translations={{ placeholder: 'ادحل اسم البلد' }} attribute='entryOrigin.country.raw' searchable={searchable} limit={20} />
                </Panel>
              </SubMenu>
              <SubMenu
                icon=""
              ...
              >
                <Panel>
                  <RefinementList translations={{ placeholder: "ادخل اسم التصنيف" }} attribute='entryClassification.theclass.key' searchable={searchable} limit={20} />
                </Panel>
              </SubMenu>
              <SubMenu
                defaultOpen={true}
              ...
              >
                <Panel>
                  <RefinementList translations={{ placeholder: "ادخل اسم الفئة" }} attribute='entryCategory.thecategory.key' searchable={searchable} limit={20} />
                </Panel>
              </SubMenu>
              <SubMenu
                defaultOpen={true}
              ...
              >
                <Panel>
                  <RefinementList translations={{ placeholder: "ادخل اسم المؤلف" }} attribute='entryauthor.name.key' searchable={searchable} limit={20} />
                </Panel>
              </SubMenu>
            </Menu>
          </Sidebar>
